...
{
  //1023 + -7.56x + 0.0251x^2 + -3.9E-05x^3 + 2.24E-08x^4  
  //676 + -3.16x + 5.74E-03x^2 + -3.85E-06x^3
  //503 + -1.53x + 1.17E-03x^2
  return 676 -3.16*x + 0.00574*x*x -0.00000385*x*x*x; // Replace this with the equation obtained from nonlinear regression analysis
}
