...
// Servo adjustment
#define _DUTY_NEU 1280  // Servo angle: 0 degree
#define _DUTY_MAX 2392  // Servo angle: D degree
#define _DUTY_MIN 500   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 290 // Replace with |D - E| degree
...
void loop()
{
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(2, 0.5));
